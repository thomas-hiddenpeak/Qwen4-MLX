...
[实际验证专家重叠](MTP_EXPERT_OVERLAP.md)已完成原11k/128诊断：55个S3验证轮次覆盖全部48层，26.7184%的专家选择在同轮同层重复。仅gate/up共享的理想节省为全部路由权重逻辑量的17.8123%，支持一个局部原型；尚无实际DRAM节省或生成收益结论，原默认和MTP发布门槛保持。
